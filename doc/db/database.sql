...
CREATE TABLE `module` (
  ...
  `uuid` char(36) NOT NULL COMMENT '生成模块访问地址',
  PRIMARY KEY (`id`),
...
CREATE TABLE `parameter` (
  ...
  `parent_id` int(11) unsigned DEFAULT NULL COMMENT '父接口编号',
  `name` varchar(255) NOT NULL COMMENT '参数名称',
  `description` varchar(255) DEFAULT '空描述' COMMENT '参数描述',
  `type` tinyint(4) DEFAULT '0' COMMENT '参数类型：0-请求 1-响应',
